...
export default function Hero() {
  return (
    <article className="text-white p-4 min-h-[16rem] h-[20rem] md:h-[24rem] mt-16">
      <div className="relative h-full">
        <img src={hero} className="blur-sm brightness-50 w-full" />
        <motion.div
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="absolute w-full h-full top-0 flex flex-col justify-center -translate-y-1/2"
        >
          <div className="text-center max-w-xl mx-auto w-full">
            <h1 className="textxl md:text-3xl font-semibold">
              Ansell Maximilian
            </h1>
